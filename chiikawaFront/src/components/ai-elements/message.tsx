...
export const Message = ({ className, from, ...props }: MessageProps) => (
  <div
    className={cn(
      ...
      from === 'user' ? 'is-user ml-auto justify-end flex-row items-end' : 'is-assistant flex-col',
      className,
    )}
    {...props}
  />
...
export const MessageContent = ({ children, className, ...props }: MessageContentProps) => (
  <div
    className={cn(
      //'flex w-fit flex-col gap-2 overflow-hidden text-xs leading-relaxed',

      '[&_div[data-streamdown="code-block"]]:rounded-xl',
      '[&_div[data-streamdown="code-block"]]:border',
      '[&_div[data-streamdown="code-block"]]:border-zinc-200',
      '[&_div[data-streamdown="code-block"]]:overflow-hidden',

      '[&_code]:font-mono [&_code]:text-[0.8125rem] [&_p]:my-1',
      '[&_div[data-streamdown="code-block-header"]]:border-none',
      '[&_div[data-streamdown="code-block-header"]]:text-[12px]',
      '[&_div[data-streamdown="code-block-header"]]:text-zinc-900',
      '[&_div[data-streamdown="code-block-header"]]:px-2',
      '[&_div[data-streamdown="code-block-header"]]:py-1',
      ...
      '[&_pre>code]:block',
      '[&_pre>code]:text-[0.65rem]',

      // 用户消息：圆角 28px，浅灰背景，轻 padding，最小高度 20px
      'group-[.is-user]:rounded-[28px]',
      'group-[.is-user]:bg-[#e4e4e7]',
      'group-[.is-user]:px-3 group-[.is-user]:py-[2px]',
      'group-[.is-user]:min-h-[20px]',
      // 这里默认没有 shadow，就不用额外去掉了，有需要可以加：
      'group-[.is-user]:shadow-sm',

      // 助手消息：透明背景，不包裹气泡（类似你那边的 borderless）
