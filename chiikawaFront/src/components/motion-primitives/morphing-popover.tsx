...
function useMorphingPopover() {
  const context = useContext(MorphingPopoverContext)
  if (!context) {
    throw new Error('useMorphingPopover must be used within MorphingPopover')
  }
  return context
}

export { MorphingPopover, MorphingPopoverTrigger, MorphingPopoverContent, useMorphingPopover }
